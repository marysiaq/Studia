...
public class Cli {
	...
	private void WysylaniePliku() {
		if(!user.isUserLoggedIn()) {
			System.out.println("U¿ytkownik nie jest zalogowany!");
			return;
		}
		System.out.println("Podaj nazwê pliku:");
		String filename=sc.next();
		File file = new File ("C:/Users/bm01/eclipse-workspace/CLI/Pliki/"+filename);
		if(file.exists()) {
			sendFile(file);
		}
	...
	private void sendFile(File file) {
		...
		System.out.println(cliclient.listentToAnswer());
		System.out.println("Plik zosta³ wys³any!");
	}
	...
	private void saveFile(String answ) {
		...
		fm.closeStreams();
		System.out.println("Plik zosta³ zapisany.");
	}
	...
	private void man() {
		System.out.println("Rejestracja -> Pozwala zarejestrowaæ siê nowemu u¿ytkownikowi.\n"
				+ "Logowanie -> Pozwala u¿ytkownikowi zalogowaæ siê na istniej¹ce konto. \n"
				+ "Tablica -> Wyœwietla ostatnie 10 postów z czatu.\n"
				+ "Czat -> Umo¿liwia zalogowanemu u¿ytkownikowi wysy³anie wiadomoœci do czatu. \n"
				+ "Transfer in -> Umo¿liwia zalogowanemu u¿ytkownikowi wysy³anie pliku na serwer dyskowy. \n"
				+ "Transfer out -> Umo¿liwia zalogowanemu u¿ytkownikowi pobieranie pliku z serwera dyskowego. \n"
				+ "Wylogowanie -> Wylogowuje zalogowanego u¿ytkownika. \n"
				+ "Wyjœcie -> Zamyka aplikacjê. \n");
	}
